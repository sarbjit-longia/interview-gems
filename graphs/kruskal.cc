/*
 A minimum spanning tree is a special kind of tree that minimizes the lengths (or “weights”)
  of the edges of the tree. An example is a cable company wanting to lay line to multiple neighborhoods;
...
int main(int argc, char* argv[]){
    ...
    std::cout<<"Cost with minimum spanning tree:"<< k.cost(4)<<std::endl; //6
    return 0;
}
